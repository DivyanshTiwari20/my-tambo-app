...
export default function Home() {
  ...
  return (
    <div className="bg-white text-black font-sans selection:bg-black selection:text-white antialiased overflow-x-hidden">
      {/* SECTION 1: Hero */}
      <section className="min-h-[100svh] flex items-center justify-center p-6 md:p-12 lg:p-24">
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          
          {/* Left Half: Animation / Video */}
          <div className="w-full flex justify-center lg:justify-end order-2 lg:order-1 relative group">
            {/* Subtle premium glow effect behind the video */}
            <div className="absolute inset-0 bg-blue-50/50 rounded-3xl blur-3xl scale-110 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
            ...
            <video 
              ...
              muted 
              playsInline 
              className="w-full max-w-lg rounded-3xl object-contain drop-shadow-sm border border-gray-100 bg-white relative z-10 transition-transform duration-500 hover:scale-[1.02]"
            >
          ...
          {/* Right Half: Text and Links */}
          <div className="space-y-10 order-1 lg:order-2">
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl xl:text-7xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-500">
                SQL Query <br /> Builder.
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 font-medium leading-relaxed max-w-xl">
                What this app does: It transforms your natural language into powerful database queries and beautiful automated data visualizations instantly.
              </p>
            ...
            <div className="pt-8 text-sm font-medium text-gray-400 flex items-center gap-3">
              ...
              <p className="animate-pulse">Scroll down for more features</p>
            </div>
          </div>
      ...
      <section className="min-h-screen flex items-center justify-center p-6 md:p-12 bg-zinc-50 border-t border-zinc-200">
        <div className="max-w-5xl w-full space-y-16 py-12">
          <div className="space-y-6 text-center max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">How it Works</h2>
            <p className="text-xl text-gray-600">
              The AI interprets your intent, securely queries your connected integration, and dynamically renders the most appropriate component—like a pie chart, a line graph, or a data table—to display your results perfectly.
            </p>
          </div>
